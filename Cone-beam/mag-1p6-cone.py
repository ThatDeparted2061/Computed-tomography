...
def main():
    ...
    params = {
        ...
        'min_file_num': 1, # Changed to 1.txt
        'max_file_num': 360, # Changed to 360.txt
        'num_slices_to_reconstruct': 181, # Changed to 181 slices
        'start_angle': 0, # Degrees
        'end_angle': 360, # Changed to 360 degrees
        'source_to_detector': 800.0, # Changed to 800 mm
        'source_to_object': 500.0,   # Changed to 500 mm (center of rotation)
        'detector_pixel_size': 0.200, # Changed to 200 microns (0.2 mm)
        ...
        'apply_sinogram_straightening': True, # NEW: Option to apply sinogram straightening
        'straightening_method': 'COM',      # NEW: Method for sinogram straightening ('COM' or 'PEAK')
    ...
    try:
        ...
        # 2. Preprocess Data (log transform, flat field, mild denoising)
        ...
        # 3. Apply Sinogram Straightening (NEW STEP)
